...
/*
  IPEM Plus MAC Address:	3C:DC:75:83:99:40
  IPEM Plus Serial ID:	83FFFE75DC3C
...
void setup() {
  ...
  Serial.print("IPEM Plus MAC Address:\t");
  Serial.println(WiFi.macAddress());

  Serial.printf("IPEM Plus Serial ID:\t%04X", (uint16_t)(chipid >> 32));
